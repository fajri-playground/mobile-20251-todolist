...
class TodoProvider extends ChangeNotifier {
  ...
  TodoFilter _currentFilter = TodoFilter.semua; // Filter yang sedang aktif
  ...
  List<Todo> get todos {
    ...
    if (_currentFilter == TodoFilter.semua) {
        ...
        children: [
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    ...
                    child: Row(
                      children: [
                        // Filter chip untuk "Semua"
                        _FilterChip(
                          text: "Semua",
                          filter: TodoFilter.semua,
                          isSelected:
                              todoProvider.currentFilter == TodoFilter.semua,
                        ),
                        const SizedBox(width: 8),
                        // Filter chip untuk "Aktif"
                        _FilterChip(
                          text: "Aktif",
                          filter: TodoFilter.aktif,
                          isSelected:
                              todoProvider.currentFilter == TodoFilter.aktif,
                        ),
                        const SizedBox(width: 8),
                        // Filter chip untuk "Selesai"
                        _FilterChip(
                          text: "Selesai",
                          filter: TodoFilter.selesai,
                          isSelected:
                              todoProvider.currentFilter == TodoFilter.selesai,
                        ),
                      ],
                    ),
                  ),
          ...
          Expanded(
            child: todoProvider.todos.isEmpty
                ...
                : // DAFTAR TUGAS: Tampilan daftar tugas dengan ListView
                  ListView.builder(
...
// === WIDGET BOTTOM SHEET UNTUK TAMBAH TUGAS ===
